  ...
  return (
    <aside className="sticky top-0 z-40 w-full shrink-0 border-b border-zinc-200 bg-zinc-100 sm:w-56 sm:self-start sm:border-b-0 sm:border-r">
      <nav className="flex flex-col gap-1 p-3 sm:p-4">
        ...
        <Link
          href="/"
          className="flex items-center gap-2.5 rounded-lg px-3 py-2.5 text-[15px] font-semibold leading-snug tracking-[-0.02em] text-zinc-900 transition hover:bg-zinc-200/80 active:bg-zinc-200"
        >
          <BarChart3
